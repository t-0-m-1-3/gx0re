...
func main() {
	...
	fmt.Print(".............................................\n")
	fmt.Print(".............................................\n")
	fmt.Print("    GGGGGGGGGGGGG                                          000000000     RRRRRRRRRRRRRRRRR                    EEEEEEEEEEEEEEEEEEEEEE")
	fmt.Print(" GGG::::::::::::G                                        00:::::::::00   R::::::::::::::::R                   E::::::::::::::::::::E")
	fmt.Print(" GG:::::::::::::::G                                      00:::::::::::::00 R::::::RRRRRR:::::R                  E::::::::::::::::::::E")
	fmt.Print(" G:::::GGGGGGGG::::G                                     0:::::::000:::::::0RR:::::R     R:::::R                 EE::::::EEEEEEEEE::::E")
	fmt.Print("G:::::G       GGGGGG                 xxxxxxx      xxxxxxx0::::::0   0::::::0  R::::R     R:::::R                   E:::::E       EEEEEE")
	fmt.Print("G:::::G                                x:::::x    x:::::x 0:::::0     0:::::0  R::::R     R:::::R                   E:::::E")
	fmt.Print("G:::::G                                 x:::::x  x:::::x  0:::::0     0:::::0  R::::RRRRRR:::::R                    E::::::EEEEEEEEEE")
	fmt.Print("G:::::G    GGGGGGGGGG ---------------    x:::::xx:::::x   0:::::0 000 0:::::0  R:::::::::::::RR   ---------------   E:::::::::::::::E")
	fmt.Print("G:::::G    G::::::::G -:::::::::::::-     x::::::::::x    0:::::0 000 0:::::0  R::::RRRRRR:::::R  -:::::::::::::-   E:::::::::::::::E")
	fmt.Print("G:::::G    GGGGG::::G ---------------      x::::::::x     0:::::0     0:::::0  R::::R     R:::::R ---------------   E::::::EEEEEEEEEE")
	fmt.Print("G:::::G        G::::G                      x::::::::x     0:::::0     0:::::0  R::::R     R:::::R                   E:::::E")
	fmt.Print("G:::::G       G::::G                     x::::::::::x    0::::::0   0::::::0  R::::R     R:::::R                   E:::::E       EEEEEE")
	fmt.Print("G:::::GGGGGGGG::::G                    x:::::xx:::::x   0:::::::000:::::::0RR:::::R     R:::::R                 EE::::::EEEEEEEE:::::E")
	fmt.Print("GG:::::::::::::::G                   x:::::x  x:::::x   00:::::::::::::00 R::::::R     R:::::R                 E::::::::::::::::::::E")
	fmt.Print("GGG::::::GGG:::G                  x:::::x    x:::::x    00:::::::::00   R::::::R     R:::::R                 E::::::::::::::::::::E")
	fmt.Print("GGGGGG   GGGG                 xxxxxxx      xxxxxxx     000000000     RRRRRRRR     RRRRRRR                 EEEEEEEEEEEEEEEEEEEEEE")
	fmt.Print(".............................................\n")
	fmt.Print(".............................................\n")
	fmt.Print(".............................................\n")
	fmt.Print(".............................................\n")
	fmt.Print(".............................................\n")
	fmt.Print(",_---~~~~~----._         \n")
	fmt.Print("_,,_,*^____      _____``*g*\\*, \n")
	fmt.Print("\\ __\\ \\'     ^.  \\      \\ ^@q   f \n")
	fmt.Print("[  @f | @))    |  | @))   l  0 _\\  \n")
	fmt.Print(" \\`\\   \\~____\\ __\\____\\   \\   \n")
	fmt.Print("|           _l__l_           I   \n")
	fmt.Print("}          [______]           I  \n")
	fmt.Print("]            | | |            |  \n")
	fmt.Print("]             ~ ~             |  \n")
